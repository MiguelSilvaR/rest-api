...
function getGameSystems(req, res) {
  try {
    ...
    console.log(Gamesystems);
    Gamesystems.findAll({/*include: [{model: orderstatus}]include: [{ all: true, nested: true }]*/
    })
    .then((consoles) => {
...
function getGameSystemById(req, res) {
  ...
  try {
    ...
    console.log("gamesystem by id..." + id);//console.log(gamesystems);
    ...
    console.log("Was an error");controllerHelper.handleErrorResponse(MODULE_NAME, getGameSystembyId.name, error, res);
  }
}
...
function createGameSystem(req, res) {
  ...
  try {
    ...
    return Gamesystems.create({
      name: mygamesystem.name,description: mygamesystem.description,
    }, {
...
function updateGameSystem(req, res) {
  ...
  try {
    ...
    .then(mygamesystem => {
      ...
      return mygamesystem.update({ name: myupdategamesystem.name, description: myupdategamesystem.description })
